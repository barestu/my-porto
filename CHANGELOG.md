...
- `GoogleTagManager` component to integrate Google Analytics 4 (gtag.js) tracking.
- `.env.example` file documenting the `VITE_GA_ID` environment variable for GA4 configuration.
